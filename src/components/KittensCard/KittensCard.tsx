...
interface KittenCardProps {
  ...
  queryKittens: Kitten[]; // Добавляем новый проп
}

const KittensCard = ({ editKitten, queryKittens }: KittenCardProps) => {
  const dispatch = useAppDispatch();
  // Нам больше не нужно доставать items отсюда, так как мы получаем отфильтрованных котят через пропсы.
  // Оставляем только isLoading
  ...
  return (
    <>
      <table className={styles.table}>
        ...
        <tbody>
          {/* Мапим отфильтрованный массив queryKittens */}
